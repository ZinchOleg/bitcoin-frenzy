...
import { sellBitcoin } from '../redux/slices/balance'
import { bitcoinPriceSelector } from '../redux/slices/bitcoinPrice'
import { sellBitcoinMessage } from '../redux/slices/history'
...
export default function Buy() {
  ...
  return (
    <div className='px-10 flex flex-col items-center justify-center gap-y-10 h-full relative'>
      ...
      <p className='absolute top-12 text-[#ffdf2e] text-xl'>{price >= 10000? 'Prices are high, sell now!' : 'The prices are low, are you sure that you want to sell'}</p>
      ...
      <div className='flex items-center gap-x-5 text-2xl'>
        <button
          ...
          onClick={() => {
            ...
            dispatch(sellBitcoinMessage(price))
          }}
        >
          Sell <span className='text-[#ffdf2e] group-hover:text-[#121212] transition-all'> 1 </span> BITCOIN
        </button>
      </div>
      ...
      >
        <div className='flex flex-col gap-y-12 justify-center items-center bg-[#FFFFFF40] w-[500px] h-96 text-[#121212] p-8 relative'>
          <p className='text-2xl text-center'>
            The prices are low, are you sure that you want to sell <span className='text-[#ffdf2e]'>1</span> bitcoin for <span className='text-[#ffdf2e] mx-2'>{price} $</span>?
          </p>
